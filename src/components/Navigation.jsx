...
margin-right:7rem;
   ...
   .signUp:hover{
     background-color:rgba(42,207,207,.5) ;
  ...
  <div className=" collapse navbar-collapse" id="navbarNav">
    <ul className="navbar-nav links">
      <li className="nav-item">
        <a className="nav-link item_links" href="#/">Features <span className="sr-only">(current)</span></a>
      </li>
      <li className="nav-item">
        <a className="nav-link item_links" href="#/">Pricing</a>
      </li>
      <li className="nav-item">
        <a className="nav-link item_links" href="#/">Resources</a>
      </li>
    </ul>
    <div className="logUser ml-auto">
